...
class ColorArt {
    ...
    private int findEdgeColor() {
        ...
        double COLOR_THRESHOLD_MINIMUM_PERCENTAGE = 0.01;
        ...
        while (sortedColorIterator.hasNext()) {
            ...
            double EDGE_COLOR_DISCARD_THRESHOLD = 0.3;
    ...
    private void findTextColors(HashBag<Integer> colors) {
        ...
        while (iterator.hasNext()) {
            ...
            float MINIMUM_SATURATION_THRESHOLD = 0.15f;
    ...
    private class CountedColor implements Comparable<CountedColor> {
        ...
        @Override
        public int compareTo(@NonNull CountedColor another) {
