...
/**
 * Created by mt.karimi on 6/20/2016.
...
import fragments.tool.converters.Unit;
import mt.karimi.ronevis.R;
import ronevistour.PageIndicator;
...
//        canvas.drawRoundRect(left, top, right, bottom, mPaint);
        indicatorRectF.set(left, top, right, bottom);
        canvas.drawRoundRect(
                indicatorRectF, Unit.dpToPx(3),
                Unit.dpToPx(3), mPaint);
    }
