...
import static fragments.views.horizontalwheelview.HorizontalWheelView.SCROLL_STATE_DRAGGING;
import static fragments.views.horizontalwheelview.HorizontalWheelView.SCROLL_STATE_IDLE;
import static fragments.views.horizontalwheelview.HorizontalWheelView.SCROLL_STATE_SETTLING;
...
class TouchHandler extends GestureDetector.SimpleOnGestureListener {
    ...
    private void runFlingAnimation(float velocity) {
        ...
        scrollAnimator = ValueAnimator.ofFloat(startAngle, endAngle).setDuration(duration);
