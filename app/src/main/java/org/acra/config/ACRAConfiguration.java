...
public final class ACRAConfiguration implements Serializable {
    ...
    ACRAConfiguration(@NonNull ConfigurationBuilder builder) {
        additionalDropBoxTags = new ImmutableSet<>(builder.additionalDropBoxTags());
        additionalSharedPreferences = new ImmutableSet<>(builder.additionalSharedPreferences());
        connectionTimeout = builder.connectionTimeout();
        reportContent = new ImmutableSet<>(builder.reportContent());
        ...
        logcatArguments = new ImmutableList<>(builder.logcatArguments());
        ...
        excludeMatchingSharedPreferencesKeys = new ImmutableSet<>(builder.excludeMatchingSharedPreferencesKeys());
        excludeMatchingSettingsKeys = new ImmutableSet<>(builder.excludeMatchingSettingsKeys());
        ...
        httpHeaders = new ImmutableMap<>(builder.httpHeaders());
        reportType = builder.reportType();
        reportSenderFactoryClasses = new ImmutableSet<>(builder.reportSenderFactoryClasses());
