...
public class HttpSender implements ReportSender {
     ...
     *                mapping.get(ReportField.SOME_FIELD);
     */
    private HttpSender(@NonNull ACRAConfiguration config, @NonNull Method method, @NonNull Type type, @Nullable String formUri, @Nullable Map<ReportField, String> mapping) {
        this.config = config;
        mMethod = method;
